...
- (void)awakeFromNib{
   ...
   UIImage *image = [UIImage imageNamed:@">>.png"];
    ...
    [self.textField3 setFont:TEXT_FONT_SIZE];
    ...
    [self.view5 setBackgroundColor:FONTCOLOR_BLACKFIVE   ];
    [self.view6 setBackgroundColor:FONTCOLOR_BLACKFIVE   ];
    [self.view7 setBackgroundColor:FONTCOLOR_BLACKFIVE    ];
    [self.view8 setBackgroundColor:FONTCOLOR_BLACKFIVE   ];
...
- (void)keyboardWillShow:(NSNotification *)notification{
    ...
    if (self.frame.size.height - keyboardBounds.size.height < textFrame.origin.y +30 -offest.y) {
        [self
         .scrollView setContentOffset:CGPointMake(0, offest.y +textFrame.origin.y +30- self.frame.size.height+5 + keyboardBounds.size.height ) animated:YES];
    }
}
...
- (void)applyConstraints{
    ...
    NSDictionary *metricsDict = @{@"HText":@16,@"HView":@0,@"VviewTotext":@8,@"VviewTolabel":@20,@"VtextTolabel":@15};
    
    viewDicts = NSDictionaryOfVariableBindings(_label1,_label2,_label3,_label4,_label5,_textField1,_textField2,_view1,_view2,_view3,_view4,_view5,_view6,_view7,_view8,_textField3,_button2,_button3,_button4,_switch1);
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HText-[_label1]-HText-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HView-[_view1]-HView-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HText-[_textField1]-HText-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HView-[_view2]-HView-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HText-[_label2]-HText-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HView-[_view3]-HView-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HText-[_textField2]-HText-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HView-[_view4]-HView-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HText-[_label3]-HText-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HView-[_view5]-HView-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HView-[_view6]-HView-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HView-[_view7]-HView-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HView-[_view8]-HView-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[_switch1]-HText-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HText-[_textField3]-HText-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HText-[_label4(100)]-85-[_label5(100)]" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-HText-[_button2(100)]" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[_button3(100)]-20-|" options:0 metrics:metricsDict views:viewDicts];
    [self.customView addConstraints:constraints];
  //  constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"[_button3][_label5]|" options:NSLayoutFormatAlignAllLeft metrics:metricsDict views:viewDicts];
  //  [self.customView addConstraints:constraints];
     if (typeFlag == 1) {
        constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-VviewTolabel-[_label1]-3-[_view1(1)]-VviewTotext-[_textField1]-VviewTotext-[_view2(1)]-VviewTolabel-[_label2]-3-[_view3(1)]-VviewTotext-[_textField2]-VviewTotext-[_view4(1)]-VviewTolabel-[_label3]-3-[_view7(1)]-VviewTotext-[_textField3]-VviewTotext-[_view8(1)]-VtextTolabel-[_label4]-3-[_button2]" options:0 metrics:metricsDict views:viewDicts];
        [self.customView addConstraints:constraints];
        
        constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[_view8(1)]-VtextTolabel-[_label5]-3-[_button3]" options:0 metrics:metricsDict views:viewDicts];
        [self.customView addConstraints:constraints];
    }
    else if(typeFlag == 2){
        constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-VviewTolabel-[_label1]-3-[_view1(1)]-VviewTotext-[_textField1]-VviewTotext-[_view2(1)]-VviewTolabel-[_label2]-3-[_view3(1)]-VviewTotext-[_textField2]-VviewTotext-[_view4(1)]-16-[_view5(1)]-VviewTotext-[_label3]-VviewTotext-[_view6(1)]-VtextTolabel-[_label4]-3-[_button2]" options:0 metrics:metricsDict views:viewDicts];
        [self.customView addConstraints:constraints];
        
        constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[_view6]-VtextTolabel-[_label5]-3-[_button3]" options:0 metrics:metricsDict views:viewDicts];
        [self.customView addConstraints:constraints];
        
        constraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[_view5]-5-[_switch1]" options:0 metrics:metricsDict views:viewDicts];
        [self.customView addConstraints:constraints];
